...
export default function LoginPage() {
  ...
  const isFirstTimeUser = true // mocked; replace when real auth is wired
          ...
          <Card className="border-slate-800 bg-slate-900/70 text-slate-100 shadow-2xl backdrop-blur">
            <CardHeader className="space-y-2">
              ...
              <CardDescription className="text-lg text-slate-300">
                We'll keep your money story organized while you focus on what matters.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
                ...
                <Button
                  ...
                  className="h-12 w-full bg-emerald-500 text-lg font-semibold text-slate-950 transition hover:bg-emerald-400 dark:bg-emerald-600 dark:text-white dark:hover:bg-emerald-500"
                >
              ...
              <p className="mt-6 text-center text-sm text-slate-300">
                New here?{" "}
                <Link to="/onboarding" className="font-semibold text-emerald-300 hover:text-emerald-200">
                  Create Account
                </Link>
              </p>
            </CardContent>
